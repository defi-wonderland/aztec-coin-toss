...
import {
  ...
  export class PrivateOracleContract extends ContractBase {
    ...
    public methods!: {
      ...
      /** get_answers_unconstrained(owner: struct) */
      get_answers_unconstrained: ((owner: AztecAddressLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
      ...
      /** get_pending_questions_unconstrained(divinity: struct) */
      get_pending_questions_unconstrained: ((divinity: AztecAddressLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
  
      /** get_questions_unconstrained(requester: struct) */
      get_questions_unconstrained: ((requester: AztecAddressLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
