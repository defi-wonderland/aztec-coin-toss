...
export class PrivateOracleContract extends ContractBase {
  ...
  public methods!: {
    ...
    /** get_fee_note() */
    get_fee_note: (() => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;

    /** get_payment_token() */
    get_payment_token: (() => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;

    /** get_payment_token_note() */
    get_payment_token_note: (() => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
